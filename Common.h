...
typedef IloArray<IntArray3> IntArray4;
typedef IloArray<NumArray3> NumArray4;
typedef IloArray<BoolArray3> BoolArray4;
...
IntArray4 CreateIntArray4(IloEnv env, IloInt m, IloInt n, IloInt k, IloInt l);
NumArray4 CreateNumArray4(IloEnv env, IloInt m, IloInt n, IloInt k, IloInt l);
BoolArray4 CreateBoolArray4(IloEnv env, IloInt m, IloInt n, IloInt k, IloInt l);
